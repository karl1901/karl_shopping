  ...
  <div v-if="!props.item.meta?.hidden" :class="{ 'simple-mode': props.isCollapse, 'first-level': props.isFirstLevel }">
    <template v-if="!alwaysShowRootMenu && theOnlyOneChild && !theOnlyOneChild.children">
      <SidebarItemLink v-if="theOnlyOneChild.meta" :to="resolvePath(theOnlyOneChild.path)">
        <el-menu-item :index="resolvePath(theOnlyOneChild.path)">
          ...
          <i mr-12px v-else-if="theOnlyOneChild.meta.iIcon" class="iconfont" v-html="theOnlyOneChild.meta.iIcon" />
    ...
    <el-sub-menu v-else :index="resolvePath(props.item.path)">
      <template #title>
        ...
        <i mr-12px v-else-if="props.item.meta && props.item.meta.iIcon" class="iconfont" v-html="props.item.meta.iIcon" />
